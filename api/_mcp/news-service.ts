...
const PRODUCT_SIGNAL = /(?:產品|工具|功能|平台|API|應用|服務|框架|資料集|數據集|系統|軟件|套件|插件|儀表盤|瀏覽器|代碼託管|開發工具|智能體)/i;
const RELEASE_SIGNAL = /(?:發佈|發布|推出|上線|更新|升級|開源|問世|新增|加入|支援|支持|release|launch|ship|introduc)/i;
